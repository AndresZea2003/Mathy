...
<template>
    <div class="menu__div--container w-full h-full relative overflow-hidden">
        ...
        <div>
            ...
            <grid-screen :currentShip="currentShip" :arrayAccess="arrayAccess" :unlockedLevelsStorage="props.unlocked_levels_storage" v-if="responsiveGrid"/>
            <grid-mobile :currentShip="currentShip" :arrayAccess="arrayAccess" :unlockedLevelsStorage="props.unlocked_levels_storage" v-else/>
        </div>
    </div>
</template>
