...
import {types, sizes, localHost, getSelectItem, playAudio} from '../../use';
  ...
  <div
    ...
    <div class="w-full flex justify-center">
      <div class="grid grid-cols-2 gap-4 w-full">
        ...
        <div @click="selectItemPalette(item)" v-for="item in props.items" :id="item.name"
             class="flex justify-center items-center w-full h-full">
          <button
              :class="['bg-gray-100 shadow-md rounded-lg hover:opacity-75 hover:scale-95 duration-300 select-none ' +
               'font-bold text-6xl w-20 h-20 flex justify-center items-center' , ]">
